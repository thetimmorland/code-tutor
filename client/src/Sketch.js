...
export default function Sketch(props) {
  ...
  // const p5 = ;
  // const script = `<script src="${p5}"></script><script>${value}</script>`;
  // const style = `<style type="text/css">body{margin:0;padding:0;}</style>`;
  // const srcDoc = `<html><head>${style}${script}</head></html>`;
